import{I3 as be,H$ as we,Ik as xe,xT as f,y0 as w,I8 as De,Gv as B,xU as r,dM as z,xl as ee,I2 as Ve,x_ as E,bp as te,bm as A,gC as H,Il as ye,h0 as ie,xS as ne,GQ as S,eX as _,bl as v,Im as se,y2 as ae,bn as o,mm as re,gB as Le,ro as Ee,bq as Se,bC as le,fS as oe,gz as Ce,I0 as Me,xz as Ae,GO as $e,Hn as Re,y1 as F,ct as Te,qq as ce,qs as he,_ as de,eZ as Ie,ck as G,q1 as q,q as c,w as j,jG as pe,e_ as ue,bj as Oe,bo as O,lv as Ue,G$ as qe,lx as ze,In as je,y9 as D,nU as Ne,nV as k,Io as We,m$ as Be,Ip as $,Iq as He,wx as X,rk as Fe,ut as Ge,rl as ke,rm as Xe,rn as Qe,rp as Ze,v as C,Ir as Je,cm as Q}from"./index-BPwjGXZE.js";import{t as Ke}from"./VisualElement-D-O-4LRi.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(xe),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=z(6);function ge(t){const e=new ee;e.include(Ve),e.include(fe,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new E("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(x,l),te(x,x,u),A(d,x),d[3]=H(x),d)),new ye("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/H(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
