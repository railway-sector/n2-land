import{xl as te,Hl as ie,Hm as re,xZ as ae,Hn as se,Ho as oe,xU as o,x$ as ne,GO as ce,xS as le,y1 as y,Hp as pe,Hq as de,GS as R,xW as he,xX as ve,xY as ue,x_ as me,Gv as fe,Hr as U,Hs as E,Ht as Se,Hu as ge,GT as Pe,e_ as ye,qq as xe,jG as we,qs as _e,_ as ze,qu as D,Gx as G,Gy as $e,Gz as q,qv as L,y4 as be,GA as ke,y6 as Ve,Hv as Oe,Hw as I,Hx as B,Hy as Te,Hz as Ce,HA as We,q as d,w as De,GV as Me,y9 as m,ew as Le,GC as M,GY as je,HB as Y,sR as He,Hk as Ae,HC as Fe,yb as Ne,bo as X,kw as Re,eX as Q,bn as Z,HD as Ue}from"./index-DbxUDf4w.js";function J(r){const e=new te,{space:a,anchor:t,hasTip:x,hasScreenSizePerspective:w}=r,f=a===2,k=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:g,varyings:S}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),S.add("vColor","vec4"),S.add("vpos","vec3",{invariant:!0}),S.add("vUV","vec2"),S.add("vSize","float"),x&&S.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
